export default function GrammarCard({ grammar_score, grammar_text }) {
    ...
    return (
        <section className="bg-[#1e3a8a] rounded-3xl p-8 md:p-10 text-white shadow-xl shadow-blue-900/20">
            <div className="flex flex-col md:flex-row gap-8 md:gap-10 items-start">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="bg-black/10 rounded-2xl p-6 border border-white/10 w-full min-w-0 overflow-hidden">
